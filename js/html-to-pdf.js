...
(function (LineNumberingMode) {
    LineNumberingMode["None"] = "none";
    LineNumberingMode["Inside"] = "inline";
    LineNumberingMode["Outside"] = "outside";
...
class HtmlToPdfService {
    ...
    constructor() {
         ...
         */
        this.LI_MARGIN_BOTTOM = 8;
        /**
         * Normal line height for paragraphs
         */
        this.LINE_HEIGHT = 1.25;
        /**
         * space between paragraphs
         */
        this.P_MARGIN_BOTTOM = 4.0;
        /**
         * Space above H
         */
        this.H_MARGIN_TOP = 10.0;
        /**
    ...
    parseElement(element, styles) {
        ...
        switch (nodeName) {
            ...
            case 'div': {
                ...
                newParagraph = Object.assign({}, newParagraph, this.computeStyle(styles), this.computeStyle(this.elementStyles[nodeName]));
                break;
            }
            case 'a':
            case 'b':
            ...
            case 'span': {
                ...
                if (element.getAttribute('data-line-number') && !this.isInsideAList(element)) {
                    ...
                    const children = this.parseChildren(element, styles);
                    newParagraph = Object.assign({}, this.create('text'), this.computeStyle(styles));
                    newParagraph.text = children;
                }
                break;
            }
            ...
            default: {
                newParagraph = Object.assign({}, this.create('text', element.textContent.replace(/\n/g, '')), this.computeStyle(styles));
                break;
            }
        }
        return newParagraph;
    ...
    extractLineNumbers(element) {
        ...
        if (lineNumber) {
            ...
            // the text.
            if (!this.getLineNumber(element.nextSibling)) {
